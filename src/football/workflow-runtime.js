...
// → 舊能量表單相容 → 整體場域語意 → iPad 響應式樣式 → 雙牌源賽後回顧分流 → 雙牌源同場比較
...
// - 本層固定場域、淘汰賽、iPad 樣式、雙牌源回顧分流、雙牌源比較、統計與運彩包裝完成的核心／Render，後續模組只接收這份快照。
