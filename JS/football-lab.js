// 世足賽事驗證 v1.7.4｜相容載入器
// 依序載入雲端設定、帳戶、資料、核心、比分規則、渲染、淘汰賽流程、單張能量、事件、雲端同步、紀錄介面、統一卡片、單一編輯、紀錄版面、後續牌組輸入保留、狀態分頁修正與滾動績效觀察。時間 O(m)，空間 O(1)，m=28。
(function loadFootballLabModules() {
  "use strict";

  const version = "20260706-football-v174-performance-trends-a";
  const modules = [
    "JS/cloud-config.js",
    "JS/site-account.js",
    "JS/football-data.js",
